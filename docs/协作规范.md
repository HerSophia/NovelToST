...
5. **文档口径同步说明**（若改动 CI/workflow/scripts，需说明同步了哪些文档）

强制同步规则：

- 若修改 `.github/workflows/*.yaml`、`package.json scripts` 或测试门禁策略，PR 必须同步更新 `README.md` 与 `docs/CI-CD规划.md` 对应章节。
- PR 描述建议固定勾选项：`[ ] 文档口径已同步`。
...
- [ ] 无明显 lint/build 错误
- [ ] 文档已更新（如有新行为/新配置）
- [ ] 若涉及 workflow/scripts 变更，已同步 README 与 CI 规划文档
- [ ] PR 描述完整，便于后续追溯
